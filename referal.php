...
<?php require_once 'includes/send_to_google_sheets.php'; ?>
...
<section style="background-color: #f4f6f8; padding: 40px 20px;">
    <div class="container">
        ...
        <div class="form-wrapper">
            ...
            <?php
            // PHP Logic to Handle Form - Supports home form, referral form, and service page forms
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (empty($errors)) {
                    ...
                    // Confirmation Notice - Redirect for home/service forms, show message for referral form
