...
<section class="container" style="
    background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://www.tradex.com/images/default-source/default-album/man-with-brown-hair-stands-in-a-garage-wth-a-clipboard.png?sfvrsn=f2d95112_1');
    background-size: cover;
    background-position: center;
    background-attachment: fixed; /* Creates a professional parallax effect */
    padding-top: 60px;
    padding-bottom: 60px;
">
    ...
    <div class="text-center">
        ...
        <p class="section-subtitle" style="color: #f0f0f0;">
            Tailored protection for <strong style="color:#ffcc00;">Motor Traders</strong> with previous convictions, bans, or high-risk profiles.
        </p>
    </div>

    <div class="grid-3">
        <div class="card" style="background: #fff; box-shadow: 0 10px 20px rgba(0,0,0,0.3);">
