...
<section style="
    width: 100%;
    background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('https://www.tradex.com/images/default-source/default-album/man-with-brown-hair-stands-in-a-garage-wth-a-clipboard.png?sfvrsn=f2d95112_1');
...
">
    ...
    <div style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        ...
        <div class="text-center" style="margin-bottom: 50px;">
            ...
            <p class="section-subtitle" style="color: #f0f0f0; font-size: 1.1rem; max-width: 700px; margin: 0 auto;">
                Tailored protection for <strong style="color:#951f20; font-weight: 800; background: #fff; padding: 0 5px; border-radius: 3px;">Motor Traders</strong> with previous convictions, bans, or high-risk profiles.
            </p>
        </div>

        <div class="grid-3">
            <div class="card" style="background: #fff; box-shadow: 0 10px 20px rgba(0,0,0,0.3); border-bottom: 4px solid #951f20;">
